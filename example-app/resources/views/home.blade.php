  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('assets/index3.html')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('assets/index.html" class="nav-link')}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('assets/index2.html" class="nav-link')}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('assets/index3.html" class="nav-link')}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ url('assets/widgets.html" class="nav-link')}}">
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="Inputfname1">ชื่อ</label>
                    <input type="text" class="form-control" id="Inputfname1">
                  </div>
                  <div class="form-group">
                    <label for="Inputlname1">สกุล</label>
                    <input type="text" class="form-control" id="Inputlname1">
                  </div>
                  <div class="form-group">
                    <label for="Inputlbirthdate">วัน/เดือน/ปีเกิด</label>
                    <input type="datetime-local"class="form-control" id="Inputlbirthdate" />
                  </div>
                  <div class="form-group">
                    <label for="Inputlage">อายุ</label>
                    <input type="text" class="form-control" id="Inputlage">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="Inputllocation">ที่อยู่</label>
                    <textarea rows="4"
                    placeholder="กรุณาป้อนข้อมูล"class="form-control" id="Inputllocation"></textarea>
                  </div>
                  <div class="form-group">
